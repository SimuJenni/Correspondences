...
class CNetTrainer:
    ...
    def get_train_batch(self):
        ...
        batch_queue = slim.prefetch_queue.prefetch_queue([tiles_train])
    ...
    def train(self, chpt_path=None):
        ...
        with self.sess.as_default():
            with self.graph.as_default():
                ...
                # Compute losses
                pred_loss = self.model.prediction_loss()
                ...
                tf.summary.image('images/weights_disc_1', weights_montage(weights_disc_1, 6, 16),
                                 max_outputs=1)
