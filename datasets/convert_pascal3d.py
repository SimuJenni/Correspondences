...
NUM_CLASSES = 12
CLASSES = ['aeroplane', 'bicycle', 'boat', 'bottle', 'bus', 'car', 'chair', 'diningtable', 'motorbike', 'sofa', 'train',
           'tvmonitor']


def parse_mat(mat_file, data_path, class_name):
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session('') as sess:
            for j in range(num_images):
                ...
                mat_path = os.path.join(source_dir, 'Annotations', '{}_imagenet/{}.mat'.format(class_name, img_ids[j].strip('\n')))
