...
def _process_image(filename, coder, im_dim=256):
...
def _process_image_files_batch(coder, thread_index, ranges, name, filenames,
    ...
    for s in xrange(num_shards_per_batch):
        ...
        for i in files_in_shard:
            ...
            image_buffer, im_h, im_w = _process_image(filename, coder)

            example = image_to_tfexample(image_buffer, 'JPEG', im_h, im_w, label)
...
def run(train_directory, validation_directory, output_directory, train_shards=256, validation_shards=32, num_threads=8,
