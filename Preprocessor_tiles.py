...
class Preprocessor:
    ...
    def extract_random_patch(self, image, bbox=(0., 0., 1., 1.)):
        ...
        resized_image = tf.cond(
            ...
            fn1=lambda: tf.image.resize_bilinear(image, self.tile_shape[:2], align_corners=False),
            fn2=lambda: tf.image.resize_bicubic(image, self.tile_shape[:2], align_corners=False))
